...
# Create transitions
q0_state.add_transition(Events['ppg_on'], q4_state)
q0_state.add_transition(Events['ppz_on'], q5_state)
q2_state.add_transition(Events['ppg_on'], q4_state)
q2_state.add_transition(Events['ppz_on'], q6_state)
q3_state.add_transition(Events['ppg_off'], q2_state)
q3_state.add_transition(Events['ppz_on'], q7_state)
q4_state.add_transition(Events['ppg_off'], q2_state)
q4_state.add_transition(Events['ppz_on'], q8_state)
q5_state.add_transition(Events['ppg_on'], q8_state)
q6_state.add_transition(Events['ppz_off'], q0_state)
q6_state.add_transition(Events['ppg_on'], q8_state)
q7_state.add_transition(Events['ppg_off'], q6_state)
q8_state.add_transition(Events['ppz_off'], q3_state)
q8_state.add_transition(Events['ppg_off'], q6_state)
...
# create supervisor
se02_sobre_braco = Supervisor("se02_sobre_braco", state_list, alphabet)